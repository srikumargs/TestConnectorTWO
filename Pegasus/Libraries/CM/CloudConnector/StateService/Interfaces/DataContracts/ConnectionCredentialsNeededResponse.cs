...
namespace Sage.Connector.StateService.Interfaces.DataContracts
{
  /// <summary>
    /// 
    /// </summary>
    [DataContract(Namespace = ServiceConstants.V1_SERVICE_NAMESPACE, Name = "ConnectionCredentialsNeededResponse")]
    public class ConnectionCredentialsNeededResponse : IExtensibleDataObject
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public ConnectionCredentialsNeededResponse(string descriptions, Dictionary<string, string> currentValues, IEnumerable<String> userFacingMessages, IEnumerable<String> rawErrorMessages)
        {
        ...
        public ConnectionCredentialsNeededResponse(ConnectionCredentialsNeededResponse source, IEnumerable<PropertyTuple> propertyTuples)
        {
            ...
            var myPropertyTuples = propertyTuples.Where(x => x.Item1.DeclaringType == typeof(ConnectionCredentialsNeededResponse));
