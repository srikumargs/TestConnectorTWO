...
public:
	...
	CHyperlink(std::ofstream_t& oLogStream, const CTextAttributes& oTextAttributes, CommandType eCommandType, const std::string_t& sCommand, const std::string_t& sCommandParameters, CBrowserWindow* pBrowserWindow);
	virtual ~CHyperlink();
...
private:
	...
	CBrowserWindow* m_pBrowserWindow;
