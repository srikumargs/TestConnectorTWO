...
)
{
    ...
    if($version -eq '12.0.0.0')
    {
        ...
        Add-Type -AssemblyName ('Microsoft.TeamFoundation.Build.Common, Version=12.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a')
        Add-Type -AssemblyName ('Microsoft.TeamFoundation, Version=12.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a')
    }
